                    ...
                    <div className="chat-main-row">
                        <div className="chat-main-wrapper">
                                        ...
                                        <div className="navbar">
                                            <div className="user-details mr-auto">
                                                <div className="float-left user-img m-r-10">
                                                    <a href="/profile" title="Mike Litorus"><img src={user} alt="" className="w-40 rounded-circle" /><span className="status online"></span></a>
                                                </div>
                                                <div className="user-info float-left">
                                                    <a href="/profile" title="Mike Litorus"><span className="font-bold">Mike Litorus</span></a>
                            ...
                            <div className="col-lg-3 message-view chat-profile-view chat-sidebar" id="chat_sidebar">
                                <div className="chat-window profile-tabs">
                                    <Tabs defaultActiveKey="calls" id="uncontrolled-tab-example" className="video-windows">
